                              ...
                              children: [
                                ...
                                AnimatedBuilder(
                                  ...
                                  builder: (context, child) {
                                    return Positioned(
                                      top:
                                          _scannerAnimationController.value * h,
                                      left: 0,
                                      right: 0,
                                      child: Container(
                                        height: 3,
                                        decoration: BoxDecoration(
                                          color: mintColor.withValues(
                                            alpha: 0.0,
                                          ),
                                          boxShadow: [
                                            BoxShadow(
                                    ...
                                    child: AnimatedBuilder(
                                      ...
                                      builder: (context, child) {
                                        return Transform.scale(
                                          scale:
                                              0.95 +
                                              (_badgeAnimationController.value *
                                                  0.1),
                                          child: Container(
                                            padding: const EdgeInsets.symmetric(
                                              horizontal: 20,
      ...
      builder: (context, child) {
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: const Color(0xFF1FA85C).withValues(
                  alpha: 0.5 + (_badgeAnimationController.value * 0.5),
                ),
                blurRadius: 0 + (_badgeAnimationController.value * 6),
  ...
  Widget _buildModeText(String text, bool isSelected, Color activeColor) {
    return Text(
      ...
      style: AppFonts.heading(
        ...
        letterSpacing: 0.5,
        shadows: isSelected
            ? [Shadow(color: activeColor.withValues(alpha: 0.6), blurRadius: 0)]
            : null,
      ),
    );
  }
