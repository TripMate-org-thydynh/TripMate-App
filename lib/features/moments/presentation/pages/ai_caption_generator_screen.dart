  ...
  final List<Map<String, String>> _generatedCaptions = [
    {
      ...
      'text':
          'We got lost in Kyoto station for the 4th time, almost missed the temple, but hey... look at this coffee pattern! Priorities, guys. 💀☕',
    },
    {
      'vibe': '🍵 Cozy Aesthetic',
      'text':
          'Warm brews in a wooden Kyoto house. The rain outside can\'t compete with this cozy vibe. 🌿✨',
    },
    {
      'vibe': '🖋️ Handwritten Poetic',
      'text':
          'Lost tracks, warm steam, Kyoto dreams romanticized by four tired souls.',
    },
  ];
      ...
      setState(() {
        ...
        if (_sarcasmLevel > 80.0) {
          _generatedCaptions[0] = {
            'vibe': '🤡 Chaotic Sarcasm',
            'text':
                'Who needs maps or sense of direction when you have a 100k coffee that took 40 mins to queue? Peak luxury failure. 💅☕',
          };
        } else {
          _generatedCaptions[0] = {
            'vibe': '🤡 Chaotic Sarcasm',
            'text':
                'Kyoto ramen crawl: where we eat 5 times our body weight and pretend it was for the culture. 🍜🤡',
          };
        }
        ...
        if (_cozyLevel > 70.0) {
          _generatedCaptions[1] = {
            'vibe': '🍵 Cozy Aesthetic',
            'text':
                'Rainy mornings call for tatami shadows, green tea whispers, and quiet reflections. 🍵🌧️',
          };
        } else {
          _generatedCaptions[1] = {
            'vibe': '🍵 Cozy Aesthetic',
            'text':
                'Just standard coffee shop romanticism. Let us stay in this bubble forever. 🌿☕',
          };
        }
      });
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: neonAmber, width: 2),
                        ),
                        child: Row(
                          children: [
                            const Text(
                      ...
                      _buildSlider('🔥 Chaos Density', _chaosLevel, neonPink, (
                        val,
                      ) {
                        setState(() {
                          _chaosLevel = val;
                      ...
                      _buildSlider('🌿 Cozy Aesthetic', _cozyLevel, neonAmber, (
                        val,
                      ) {
                        setState(() {
                          _cozyLevel = val;
