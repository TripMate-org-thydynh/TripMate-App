                ...
                children: [
                  SwitchListTile(
                    ...
                    subtitle: Text(
                      ...
                      style: AppFonts.heading(fontSize: 11.5),
                    ),
                    value: _autoRenew,
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text(
                            '💳 Mở ví MoMo / Bank account để liên kết nguồn mới!',
                          ),
                          behavior: SnackBarBehavior.floating,
                        ),
                      );
                  ...
                  showDialog(
                    ...
                    builder: (context) => AlertDialog(
                      ...
                      content: Text(
                        ...
                        style: AppFonts.heading(fontSize: 13),
                      ),
                      actions: [
                        TextButton(
                          onPressed: () => Navigator.pop(context),
                        ...
                        TextButton(
                          onPressed: () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text(
                                  '💔 Đã hủy gói Elite Squad. Các đặc quyền vẫn giữ tới 20/06/2026.',
                                ),
                                behavior: SnackBarBehavior.floating,
                              ),
                            );
