...
class _SubscriptionCheckoutScreenState extends State<SubscriptionCheckoutScreen> {
  ...
  Future<void> _processPayment() async {
    ...
    // Call live NestJS backend checkout route!
    final response = await ApiService.post('/premium/checkout', {
      'tier': 'ELITE_SQUAD',
      'paymentMethod': _selectedMethod == 'VISA' ? 'Visa **** 4242' : 'Momo Wallet',
    });
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(child: _buildMethodCard('VISA', 'Visa Card 💳', isDark, primaryColor, surfaceColor)),
                const SizedBox(width: 12),
                Expanded(child: _buildMethodCard('MOMO', 'Momo Wallet 💸', isDark, primaryColor, surfaceColor)),
              ],
            ),
  ...
  Widget _buildMethodCard(String method, String label, bool isDark, Color primaryColor, Color surfaceColor) {
